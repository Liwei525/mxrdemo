...
//                            j++;
                ...
                el.ddTable.find('td:nth-child(4)').hide();
                ...
                el.ddTable.find('td:nth-child(11)').hide();
                el.ddTable.find('td:nth-child(12)').hide();
                el.ddTable.find('td:nth-child(13)').hide();
                el.ddTable.find('td:nth-child(14)').hide();
                el.ddTable.find('td:nth-child(15)').hide();
                el.ddTable.find('td:nth-child(16)').hide();
...
$(function(){
	var searchText = $("#search").tautocomplete({
        width: "250px",
        columns: ['合同号', '名称', '拼音码'],
        data: function () {
        	var filterData = [];
            $.ajax({
            	url : "pages/back/admin/ucgoodsmanage/usaid_like.action",
            	type : 'post',
            	async : false ,
            	data : {
