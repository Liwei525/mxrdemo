...
$(function(){
	...
	$("button[id^=remove-]").each(function(){
		$(this).on("click",function(){
			...
			raid = $("#raid").text() ;
			$.post("pages/back/admin/replenishapplication/remove_ucgoods.action",{raid:raid,ucid:ucid},function(data){
				if(data == true){
...
function addDetails(tucid) {
	...
	var searchText = $("#tname-" + tucid).tautocomplete({
        ...
        data: function () {
        	var filterData = [];
            $.ajax({
            	url : "pages/back/admin/replenishapplication/ucgoods_like.action",
            	type : 'post',
            	async : false ,
            	data : {
            		"raid":$("#raid").text() ,
...
function saveDetails(tucid) {
	...
	$.post("pages/back/admin/replenishapplication/add_ucgoods.action",{raid:raid,ucid:ucid,amount:amount},function(data){
		if(data == true){
