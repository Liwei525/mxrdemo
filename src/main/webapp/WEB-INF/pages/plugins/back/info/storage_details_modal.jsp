		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<div class="form-group" id="didDiv">
					<strong><span class="glyphicon glyphicon-eye-open"></span>&nbsp;查看入库单详情</strong>
				</div>
			</div>
				...
				<div>
					<table class="table table-striped table-bordered table-hover">
						<tr> 
							...
							<td id="storageTitle">双13备货</td>
						</tr>
						<tr>
							<td><strong>存入仓库名称：</strong></td>
							<td id="storageWarehouse">北京市 北京市 通州一号仓库</td>
						</tr>
						<tr>
							<td><strong>仓库类型：</strong></td>
							<td id="storageWiid">半成品库</td>
						</tr>
						<tr>
							<td><strong>入库商品总价：</strong></td>
							<td id="storageTotalPrice">￥20000</td>
						</tr>
						<tr>
							<td><strong>备注信息：</strong></td> 
							<td><pre class="pre-scrollable" style="width:800px;height:60px;" id="storageNote">发神经阿德里飞洒抵抗力 范德克鲁斯建立开放撒 方力申搭建了开发商的 发动机萨拉空间来看 234uop富士达会计分录款手机范德萨进来进来看范德萨克利夫兰斯顿卡机了开发商大量了快捷方式的拉开建立开放撒酒 刘嘉玲发撒旦机立刻地方撒刻录机弗拉基反抗螺丝钉</pre></td>
						</tr>
					</table>
				</div>
				<div>
					<table class="table table-condensed table-bordered table-hover" id="detailsTab">
						...
						<tbody id="storageDetails">
						</tbody>
					</table>
				</div>
				<div style="display: none" id="selectUsaid"></div>
