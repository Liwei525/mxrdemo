...
<%!
	public static final String REPLENISHAPPLICATION_ADD_URL = "pages/back/admin/replenishapplication/add.action" ;
%>
<script type="text/javascript" src="js/pages/back/admin/replenishapplication/replenishapplication_add.js"></script>
	...
	<div class="wrapper">
		...
		<div class="content-wrapper text-left">
				...
				<div class="panel-heading">
					<strong><span class="glyphicon glyphicon-user"></span>&nbsp;补货申请单</strong>
				</div>
				<shiro:hasPermission name="replenishapplication:add">
					<div class="panel-body">
						<form class="form-horizontal" action="<%=REPLENISHAPPLICATION_ADD_URL%>" id="myform" method="post">
							<fieldset>
								...
								<div class="form-group" id="noteDiv">
									...
									<div class="col-md-5">
										...
										<textarea id="note" name="note"
											class="form-control" placeholder="请输入补货的详细信息" rows="10"></textarea>
									</div>
									<!-- 定义表单错误提示显示元素 -->
				...
				<shiro:lacksPermission name="replenishapplication:add">
					您没有该权限哦！
