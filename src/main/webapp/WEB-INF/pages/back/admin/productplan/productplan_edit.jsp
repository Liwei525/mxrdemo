...
<%!
	public static final String PRODUCTPLAN_EDIT_URL = "" ;
%>
<script type="text/javascript" src="js/pages/back/admin/productplan/productplan_edit.js"></script>
	...
	<div class="wrapper">
		...
		<div class="content-wrapper text-left">
				...
				<div class="panel-heading">
					<strong><span class="glyphicon glyphicon-user"></span>&nbsp;编辑计划信息</strong>
				</div>
				<shiro:hasPermission name="productplan:edit">
					<div class="panel-body">
						<form class="form-horizontal" action="<%=PRODUCTPLAN_EDIT_URL%>" id="myform" method="post" enctype="multipart/form-data">
							<fieldset>
