...
<script type="text/javascript" src="js/pages/back/admin/ucgoodsstorage/ucgoodsstorage_list_myself.js"></script>
...
<%!
	...
	public static final String UCGOODSSTORAGE_UCGSID_URL = "pages/back/admin/ucgoodsstorage/ucgsid_show.action" ;
%>
					...
					<table class="table table-condensed">
						...
						<tbody>
							<tr>
								...
								<td class="text-left">
									<a href="<%=UCGOODSSTORAGE_EDIT_URL%>?sid=1">2017双十一衣帽入库</a></td>
								<td class="text-left">北京通州仓库一号库</td>
								<td class="text-center">未提交</td>
								<td class="text-center">2018-01-15</td>
								<td class="text-left">
									<a href="<%=UCGOODSSTORAGE_SUBMIT_URL%>?sid=1" class="btn btn-primary btn-xs">
										<span class="fa fa-rocket"></span>&nbsp;提交申请</a>
									<a href="<%=UCGOODSSTORAGE_LIST_DETAILS_URL%>?sid=1" class="btn btn-warning btn-xs">
										<span class="fa fa-th-list"></span>&nbsp;入库清单</a>
									<a href="<%=UCGOODSSTORAGE_DELETE_URL%>?sid=1" class="btn btn-danger btn-xs">
										<span class="glyphicon glyphicon-trash"></span>&nbsp;删除申请</a>
								</td>
							</tr>
							<tr>
								<th class="text-center">
									<a href="<%=UCGOODSSTORAGE_UCGSID_URL%>?sid=1">34231513</a>
								</th> 
								<td class="text-left">
									<a href="<%=UCGOODSSTORAGE_EDIT_URL%>?sid=1">2017双十一衣帽入库</a></td>
								<td class="text-left">北京通州仓库一号库</td>
