...
<%!
	public static final String UCGOODSSTORAGE_ADD_URL = "pages/back/admin/ucgoodsstorage/add.action" ;
%>
<script type="text/javascript" src="js/pages/back/admin/ucgoodsstorage/ucgoodsstorage_add.js"></script>
	...
	<div class="wrapper">
		...
		<div class="content-wrapper text-left">
				...
				<div class="panel-heading">
					<strong><span class="glyphicon glyphicon-user"></span>&nbsp;创建半成品入库单</strong>
				</div>
				<shiro:hasPermission name="ucgoodsstorage:add">
					<div class="panel-body">
						<form class="form-horizontal" action="<%=UCGOODSSTORAGE_ADD_URL%>" id="myform" method="post">
							<fieldset>
				...
				<shiro:lacksPermission name="ucgoodsstorage:add">
					您没有该权限哦！
