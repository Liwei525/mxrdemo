...
<%!
	public static final String CGOODS_EDIT_URL = "" ;
%>
<script type="text/javascript" src="js/pages/back/admin/cgoods/cgoods_edit.js"></script>
	...
	<div class="wrapper">
		...
		<div class="content-wrapper text-left">
				...
				<div class="panel-heading">
					<strong><span class="glyphicon glyphicon-user"></span>&nbsp;编辑成品信息</strong>
				</div>
				<shiro:hasPermission name="cgoods:edit">
					<div class="panel-body">
						<form class="form-horizontal" action="<%=CGOODS_EDIT_URL%>" id="myform" method="post" enctype="multipart/form-data">
							<fieldset>
