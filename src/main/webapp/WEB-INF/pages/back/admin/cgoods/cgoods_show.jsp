...
<script type="text/javascript" src="js/pages/back/admin/cgoods/cgoods_show.js"></script>
	...
	<div class="wrapper">
		...
		<div class="content-wrapper text-left">
				...
				<div class="panel-heading">
					<strong><span class="glyphicon glyphicon-user"></span>&nbsp;成品信息</strong>
				</div>
				<shiro:hasPermission name="cgoods:show">
					<div class="panel-body">
						<div>
							<table class="table table-condensed" >
								<tr>
									<td style="width:20%;"><strong>成品编号：</strong></td> 
									<td><span>100001</span></td>
									<td><strong>成品图片：</strong></td>
								</tr>
								<tr>
									<td><strong>成品名称：</strong></td>
									<td><span>520型号</span></td>
									<td rowspan="7"><img src="upload/emp/nophoto.png" style="height:220px;"></td>
								</tr>
								<tr>
									<td><strong>半成品组成：</strong></td>
									<td><button id="constitute-1" class="btn btn-danger btn-xs">
											<span class="glyphicon glyphicon-edit"></span>&nbsp;组成详情</button></td></td>
								</tr>
								<tr>
								...
								<div class="panel-heading">
									<h4 class="panel-title"> 
										<a data-toggle="collapse" data-parent="news" href="#contentOne">
											<strong><span class="glyphicon glyphicon-user"></span>&nbsp;成品库存详情：</strong>
										</a>
									</h4>
								</div>
				...
				<shiro:lacksPermission name="cgoods:show">
					您没有该权限哦！
...
<jsp:include page="/WEB-INF/pages/plugins/back/info/ucgoods_constitute_modal.jsp"/>
