...
<script type="text/javascript" src="js/pages/back/admin/ucgoodsstorageaudit/ucgoodsstorageaudit_edit.js"></script>
<script type="text/javascript" src="js/split_page.js"></script>
<%!
	public static final String UCGOODSSTORAGEAUDIT_EDIT_URL = "pages/back/admin/ucgoodsstorageaudit/edit.action" ;
%>
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		<div class="panel panel-info">
			...
			<shiro:hasPermission name="ucgoodsstorageaudit:edit">
				<div class="panel-body">
					...
					<div>
						<form class="form-horizontal" action="<%=UCGOODSSTORAGEAUDIT_EDIT_URL%>" id="myform" method="post">
							<fieldset>
							...
							<div class="panel-heading">
								<h4 class="panel-title"> 
									<a data-toggle="collapse" data-parent="news" href="#contentOne">
										<strong><span class="glyphicon glyphicon-user"></span>&nbsp;入库半成品清单：</strong>
									</a>
								</h4>
							</div>
			...
			<shiro:lacksPermission name="ucgoodsstorageaudit:edit">
				您没有该权限哦！
