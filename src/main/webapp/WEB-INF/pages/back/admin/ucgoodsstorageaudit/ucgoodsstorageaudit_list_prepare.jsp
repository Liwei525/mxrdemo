						...
						<tbody>
							<c:forEach items="${allUCGoodsStorageApply }" var="ucgoodsStorageApply">
								<tr>
									...
									<td class="text-center"><fmt:formatDate value="${ucgoodsStorageApply.sendDate }" type="date"/></td>
									...
									<td class="text-left">
										<a href="<%=UCGOODSSTORAGEAUDIT_EDIT_URL%>?usaid=${ucgoodsStorageApply.usaid }" class="btn btn-primary btn-xs">
